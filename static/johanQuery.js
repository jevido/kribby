...
(function () {
  ...
  johanQuery = (function (_super) {
    ...
    johanQuery.prototype.reverse = function () {
      return new johanQuery(
        johanQuery.__super__.reverse.apply(this, arguments),
      );
    };
    ...
    johanQuery.prototype.parent = function () {
      ...
      this.each(function () {
        ...
        if (
          ...
          !((_ref = this.parentElement), __indexOf.call(result, _ref) >= 0)
        ) {
    ...
    _manipulateClass = function (classNames, method) {
      return this.each(function () {
        return this.classList[method].apply(
          this.classList,
          classNames.split(" "),
        );
      });
    ...
    johanQuery.prototype.remove = function () {
      return this.each(function () {
        var _ref;
        return (_ref = this.parentElement) != null
